...
def load_data(path="/root/Hadoop_Project2/data/datamind_12k.json"):
...
def main():
    ...
    IFD_SCORE_PATH = "/root/Hadoop_Project2/data/ifd_scores.json"
    IFD_WEIGHT = 0.5  # blend heuristic (0.5) + IFD (0.5)

    # DeepSeek API settings
    DEEPSEEK_SCORE_PATH = "/root/Hadoop_Project2/data/deepseek_scores.json"

    # Paths
    INPUT = "/root/Hadoop_Project2/data/datamind_12k.json"
    TRAIN_OUT = "/root/Hadoop_Project2/data/train_data.jsonl"
    VAL_OUT = "/root/Hadoop_Project2/data/val_data.jsonl"
    REPORT_OUT = "/root/Hadoop_Project2/data/selection_report.txt"
    REJECTED_OUT = "/root/Hadoop_Project2/data/rejected.json"

    os.makedirs("/root/Hadoop_Project2/data", exist_ok=True)
